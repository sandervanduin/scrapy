...
# Set up proxy and check IP address
def setup_proxy():
    ...
    # print(opener.open('https://www.amazon.co.uk/').read())

# Call the function to set up the proxy when the middleware is initialized
setup_proxy()
...
class CustomProxyMiddleware(object):
    def process_request(self, request, spider):
        ...
        #    'brd-customer-hl_79cc5ce7-zone-residential_proxy2_group5', 'iojgpx9zhee1')
